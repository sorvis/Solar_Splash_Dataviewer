...
namespace Solarsplash_Dataviewer.Tests
{
    ...
    public class DataExtractorTest
    {
        ...
        public void extractDataTest()
        {
            ...
            DataExtractor_Accessor target = new DataExtractor_Accessor(runData, "svol");
            int dataPosition = 0; // TODO: Initialize to an appropriate value
        ...
        public void getDataPositionTest()
        {
            ...
            target = new DataExtractor_Accessor(runData, "something");
            expected = 2;
            actual = target.getDataPosition();
            Assert.AreEqual(expected, actual);
        }
